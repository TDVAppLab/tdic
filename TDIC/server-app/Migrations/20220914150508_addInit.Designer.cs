...
namespace serverapp.Migrations
{
    ...
    [Migration("20220914150508_addInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_annotation_display", b =>
                {
                    ...
                    b.ToTable("t_annotation_display");
                });
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_article_length_sumarry", b =>
                {
                    ...
                    b.ToTable("t_article_length_sumarry");
                });

            modelBuilder.Entity("TDIC.Models.EDM.t_assembly", b =>
                {
                    b.Property<long>("id_assy")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("t_assembly");

                    b
                        .HasComment("組み立てに関わる基本情報を格納する");
                });
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_attachment", b =>
                {
                    ...
                    b.ToTable("t_attachment");
                });

            modelBuilder.Entity("TDIC.Models.EDM.t_instance_part", b =>
                {
                    b.Property<long>("id_assy")
                        .HasColumnType("bigint");

                    b.Property<long>("id_inst")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("id_assy", "id_inst")
                        .HasName("PK_t_instance_parts");

                    b.HasIndex("id_part");

                    b.ToTable("t_instance_part");
                });
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_instruction", b =>
                {
                    ...
                    b.ToTable("t_instruction");
                });

            modelBuilder.Entity("TDIC.Models.EDM.t_instruction_display", b =>
                {
                    b.Property<long>("id_article")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("t_instruction_display");
                });
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_part_display", b =>
                {
                    b.Property<long>("id_instruct")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("id_instruct", "id_assy", "id_inst");

                    b.ToTable("t_part_display");
                });
            ...
            modelBuilder.Entity("TDIC.Models.EDM.t_article", b =>
                {
                    b.HasOne("TDIC.Models.EDM.t_assembly", "id_assyNavigation")
                        .WithMany("t_articles")
                        .HasForeignKey("id_assy")
                    ...
                    b.Navigation("id_assyNavigation");
