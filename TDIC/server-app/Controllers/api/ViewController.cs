...
namespace API.Controllers
{
    ...
    {        
        ...
        public async Task<ActionResult> GetInstruction(string id_article,int id_view)
        {
        ...
        [HttpPost("update")]
        public async Task<IActionResult> Update([FromBody] t_viewUpdateUDto view)
        {
            //task.id = id;
        ...
        public async Task<IActionResult> Delete(string id_article, int id_view)
        {
